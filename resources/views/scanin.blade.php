@extends('scanlayouts')
@section('title', 'บันทึกเวลาเข้าโรงเรียน')
@section('content')

    <div class="mt-4" style="display:flex;">
        <div class="card m-auto" style="width: 80%">
            <div class="card-body">
                <h2 class="text-center mb-4">บันทึกเวลาเข้าโรงเรียน</h2>
                ...
                <form method="POST" action="/scanIninsert">
                    @csrf
                    <label for="studentidIn" class="form-label">บันทึกเวลาเข้าโรงเรียน</label>
