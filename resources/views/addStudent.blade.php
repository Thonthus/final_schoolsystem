...
@section('content')
    ...
    <div class="mt-4 mb-4" style="display:flex;">
        <div class="card m-auto" style="width: 80%">
            <div class="card-body">
                <h2 class="text-center mb-4 text-primary-emphasis">เพิ่มข้อมูลนักเรียน</h2>
                ...
                <form method="POST" action="/addstudent" enctype="multipart/form-data">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="รหัสห้องเรียน" name="class_id">
                        <span class="input-group-text text-primary-emphasis">เลขที่</span>
                        <input type="text" name="number" class="form-control" placeholder="เลขที่" >
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="ชื่อเล่น" name="nickname">
                        <span class="input-group-text text-primary-emphasis">วันเกิด</span>
                        <input type="date" class="form-control" placeholder="วันเกิด" name="birthdate">
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="เลขประจำตัวประชาชน" name="personal_id">
                    </div>
